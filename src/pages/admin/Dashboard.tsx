...
export default function Dashboard() {
    ...
    const links = [
        { label: "Координаторы", path: "coordinators" },
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-white via-slate-50 to-slate-100 text-slate-900">
            {/* Навбар */}
            <div className="sticky top-0 z-50 flex md:flex-row flex-col items-center justify-between px-4 md:px-8 py-4 border-b border-slate-200 bg-white/90 backdrop-blur-md shadow-sm">
